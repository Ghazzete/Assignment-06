        ...
        <>
            ...
            <div className="h-auto lg:h-[228px] bg-[#F7F7F7] mt-12 lg:mt-24 flex flex-col lg:flex-row items-center justify-between px-6 lg:px-16 gap-8 lg:gap-0">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:flex items-center gap-4">
                    <Image src={"/logos/Airbnb Logo-1.svg"} width={123.8} height={38.52} alt="one-logo" />
                    <Image src={"/logos/Airbnb Logo-2.svg"} width={123.8} height={38.52} alt="two-logo" />
                    <Image src={"/logos/Airbnb Logo-3.svg"} width={123.8} height={38.52} alt="three-logo" />
                    <Image src={"/logos/Airbnb Logo-4.svg"} width={123.8} height={38.52} alt="four-logo" />
                    <Image src={"/logos/Airbnb Logo-5.svg"} width={123.8} height={38.52} alt="five-logo" />
                    <Image src={"/logos/Airbnb Logo-6.svg"} width={123.8} height={38.52} alt="six-logo" />
                </div>
            </div>
        </>
    );
